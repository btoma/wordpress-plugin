                                          ...
                                          <div class="inside">
                                                ...
                                                <form name="wptreehouse_username_form" method="post" action="">
                                                      ...
                                                      <table class="form-table">
                                                            <tr>
                                                                  <td>
                                                                        <label for="wptreehouse_username">Treehouse
                                                                              username</label>
                                                                  </td>
                                                                  <td>
                                                                        <input name="wptreehouse_username"
                                                                               id="wptreehouse_username" type="text"
                                                      ...
                                                      <p>
                                                            <input class="button-primary" type="submit"
                                                                   name="wptreehouse_usename_submit" value="Save"/>
                                                      </p>
                              ...
                              <?php if (isset($wptreehouse_username) && $wptreehouse_username != ''): ?>
                                    <div class="postbox">
                                          ...
                                          <div class="inside">
                                                ...
                                                <p><img width="100%" class="wptreehouse-gravatar"
                                                        src="<?php echo $wptreehouse_profile->{'gravatar_url'}; ?>"
                                                        alt="Mike the Frog Gravatar"></p>
                                                ...
                                                <form name="wptreehouse_username_form" method="post" action="">
                                                     ...
                                                     <p>
                                                      ...
                                                      <input name="wptreehouse_username"
                                                             id="wptreehouse_username" type="text"
                                                             value="<?php echo $wptreehouse_username; ?>"/>
                                                      </p>
                                                      <p>
                                                            <input class="button-primary" type="submit"
                                                                   name="wptreehouse_usename_submit" value="Save"/>
